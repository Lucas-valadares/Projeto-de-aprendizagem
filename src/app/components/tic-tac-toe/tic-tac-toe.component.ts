...
export class JogoDaVelhaService {
  ...
  private numMovimentos: number | any;
  private vitoria: any;

  private _jogador: number | any;
  private _showInicio: boolean | any;
  private _showTabuleiro: boolean | any;
  private _showFinal: boolean | any;
...
/** Retorna se a tela de início deve ser exibida. */
  get showInicio(): boolean | any {
    return this._showInicio;
  }

/** Retorna se o tabuleiro deve ser exibido. */
  get showTabuleiro(): boolean | any {
    return this._showTabuleiro;
  }

/** Retorna se a tela de fim de jogo deve ser exibida. */
  get showFinal(): boolean | any {
    return this._showFinal;
  }

/**  Retorna o número do jogador a jogar. */
  get jogador(): number | any {
